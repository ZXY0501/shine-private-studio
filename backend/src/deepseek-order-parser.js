...
function buildMessages(input) {
  const system = [
    ...
    '表单里可能残留未删除的模板文字。括号内的填写说明、收费说明、示例、候选项和操作提示都不是顾客答案。',
    '字段冒号后为空时，不得把下一行的括号说明或候选项列表补成答案；没有明确填写就返回 null。',
    '“如果是国乙男主直接报名字”“换耳朵+1r/角色”“与帽子颜色不一致+1r/角色”“请发例图给我”等都是模板提示，不是角色设定。',
